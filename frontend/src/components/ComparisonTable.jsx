              ...
              <tr key={vendor.vendor_id} className="hover:bg-gray-50">
                ...
                <td>
                  ...
                  <div className={`text-xs ${getQualityColor(vendor.quality_score)}`}>
                    {getQualityGrade(vendor.quality_score).grade}
                  </div>
                </td>
                <td className="font-medium text-gray-900">
                ...
                <td>
                  <div className="font-medium text-primary-600">
                    {calculateValueIndex(vendor.quality_score, vendor.cost_per_record)}
                  </div>
                </td>
                <td>
                  <div className="font-medium text-gray-900">
                    {formatPercentage(vendor.metrics_breakdown?.pii_completeness || 0)}
                  </div>
                </td>
                <td>
                  <div className="font-medium text-gray-900">
                    {formatPercentage(vendor.metrics_breakdown?.disposition_accuracy || 0)}
                  </div>
                </td>
                <td className="text-gray-900">
                  {(vendor.total_records || 0).toLocaleString()}
                </td>
                <td>
                  <button
